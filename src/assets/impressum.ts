export const impressum =
    `
<div class="modal-impressum-address address-impressum">
                        <div class="address-impressum__title address-impressum__title--margin">
                            Angaben gemäß § 5 DDG
                        </div>
                        <div class="address-impressum__text">
                            JAR GbR
                            Roseburger Straße 1
                            21514 Güster
                        </div>
                        <div class="address-impressum__title">
                            Vertreten durch:
                        </div>
                        <div class="address-impressum__text">
                            Jan Ole Krugmann
                        ...
                        <div class="address-impressum__text">
                            E-Mail: contact@myeidos.ai
                        </div>
                    </div>
                    <div class="modal-impressum-text text-impressum">
                        <div class="text-impressum__title">Haftung für Inhalte</div>
                        <div class="text-impressum__text">
                        ...
                        <div class="text-impressum__title">Haftung für Links</div>
                        <div class="text-impressum__text">
                        ...
                        <div class="text-impressum__title">Urheberrecht</div>
                        <div class="text-impressum__text">
                        ...
                        <div class="text-impressum__title">Datenschutz</div>
                        <div class="text-impressum__text">
